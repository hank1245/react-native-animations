...
function Item({ item }) {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      scale1.value = withRepeat(withTiming(1, { duration: 1500 }), -1);
    }, 200);
    setTimeout(() => {
      ...
      scale2.value = withRepeat(withTiming(1, { duration: 1500 }), -1);
    }, 400);
    setTimeout(() => {
      ...
      scale3.value = withRepeat(withTiming(1, { duration: 1500 }), -1);
    }, 600);
  }, []);
  ...
  return (
    <>
      ...
      ></Animated.View>
      <Animated.View
        style={[styles.core, { left: item.x }, { bottom: item.y }]}
      />
    </>
  );
}
